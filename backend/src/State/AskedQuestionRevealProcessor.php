 ...
 */
final readonly class AskedQuestionRevealProcessor implements ProcessorInterface
{
    ...
    public function process(
        ...
        return AskedQuestionResource::fromEntity($this->questionService->reveal($question, $player));
    }
}
