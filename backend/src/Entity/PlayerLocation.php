...
#[ORM\Table(name: 'player_locations')]
#[ORM\Index(name: 'idx_location_round_player', columns: ['round_id', 'player_id'])]
class PlayerLocation
{
    ...
    public function __construct(Round $round, Player $player, Point $point, ?float $altitude = null)
    {
